...
function getClient()
{
    ...
    $client->setAuthConfig('credentials-create.json');
...
//   }
// }
    $calendars['francescroldan@gmail.com'] = 'francescroldan@gmail.com';
    $calendars['WeFitter'] = '632obrok1tgp230rta4q44vub4@group.calendar.google.com';
    $calendars['Horas Autónomo'] = '1ge1tkk0r2skj38cdf7envssu0@group.calendar.google.com';
    $calendars['Cohousing'] = '5mbfgeu1h14td4vdkhb132mvf0@group.calendar.google.com';
    $calendars['coopcalmet@gmail.com'] = 'coopcalmet@gmail.com';
    $calendars['Festius Catalunya'] = 'aov5ifrj7lr3ql2dqtru77rkk4@group.calendar.google.com';
    $calendars['Contacts'] = '#contacts@group.v.calendar.google.com';
    $calendars['Festivos en España'] = 'es.spain#holiday@group.v.calendar.google.com';

    $calendarId = $calendars['WeFitter'];
